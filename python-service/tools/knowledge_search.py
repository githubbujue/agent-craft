...
class KnowledgeSearchTool(Tool):
    ...
    def execute(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 阈值语义 = 余弦相似度(0-1)。实测校准: 库内问题 0.5-0.63, 库外 0.25-0.35
        similarity_threshold = parameters.get("similarity_threshold", 0.45)
        ...
        for doc in docs:
            ...
            # 余弦相似度存在 metadata["score"] (vector_store 写入), doc 上无 score 属性
            scores.append(float(doc.metadata.get("score", 0.5)))
